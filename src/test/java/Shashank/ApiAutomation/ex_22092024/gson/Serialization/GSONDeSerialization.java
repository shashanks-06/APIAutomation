...
//  -----------------------------------------------------------------------------------------------------------
//           Transportation of the jsonPayload over the internet to the Server
...
//           JsonString to Java Object
           // Parse - DeSerilization
            BookingResponse bookingResponse = gson.fromJson(responseString, BookingResponse.class);
           System.out.println(bookingResponse.getBookingid());
           System.out.println(bookingResponse.getBooking().getFirstname() + " " + bookingResponse.getBooking().getLastname());

//           Verification
           assertThat(bookingResponse.getBooking().getFirstname()).isEqualTo("Shashank");
           assertThat(bookingResponse.getBooking().getLastname()).isEqualTo("Surjekar");
